...
it operates, stuff like setting a mark /just work/ without reimplementing them.
...
searching for any links within it.
...
to make them more visible.  User can implement their own node title coloring
defun with ~denote-tree-title-colorize-function~.
